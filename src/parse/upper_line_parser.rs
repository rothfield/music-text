...
pub fn parse_upper_line(input: &str, line_num: usize) -> Result<UpperLine, ParseError> {
...
mod tests {
    ...
    fn test_upper_octave_markers() {
        ...
        let result = parse_upper_line(".  : *", 1).unwrap();
    ...
    fn test_slurs() {
        // Test input at EOI (no newline needed)
        let result = parse_upper_line("___", 1).unwrap();
    ...
    fn test_ornaments() {
        // Test input at EOI (no newline needed)
        let result = parse_upper_line("<123>", 1).unwrap();
        assert_eq!(result.elements.len(), 1);
    ...
    fn test_chords() {
        // Test input at EOI (no newline needed)
        let result = parse_upper_line("[C]", 1).unwrap();
        assert_eq!(result.elements.len(), 1);
    ...
    fn test_mixed_elements() {
        // Test input at EOI (no newline needed)
        let result = parse_upper_line(".   ___  <S> ~", 1).unwrap();
